...
//oid main() => GPesq("milho"); //runApp(const GPesq("milho"));
...
Future<Result> fetchPesq(String keyPesq) async {
  ...
  if (res.statusCode == 200) {
    ...
    throw Exception(Result(title: 'Falha ao retornar dados do Google.'));
  }
}
...
Future<Map<String, String>> GPesq(String keyPesq) async {
  late Result futurePesq;
  late Map<String, String> itensMap = new Map();
